...
var firstOption = Ti.UI.createButton({    
    ...
    title: 'metallic material that consists of titanium mixed with other metals',
	color: 'white',
    height:150,
    top:140,
    align:'center',
...
var secondOption = Ti.UI.createButton({    
    backgroundImage:'button.png', 
    title: 'MVC framework for mobile application development',
	color: 'white',
    height:150,
    top:295,
    align:'center',
...
var thirdOption = Ti.UI.createButton({    
    backgroundImage:'button.png', 
    title: 'name of appcelerator’s cloud service suite',
	color: 'white',
    height:150,
    top:460,
    align:'center',
